...
namespace Aura {
	...
	public static class AggregationHelper {
		...
		/// </summary>
        /// <param name="queryDocument">The query used to filter the pipeline document</param>
		public static BsonDocument Match(BsonDocument queryDocument) {
            return new BsonDocument("$match", queryDocument);
		}
